<template>
  <section
    ...
    :class="'location-widget_' + widgetData.widgetSize + '-size'"
  >
    <div class="location-widget__text">
      ...
      <p style="margin: 5px 0 20px">
        {{
          widgetData.isMylocation
            ? widgetData.location
            : widgetData.forecastTime
        }}
      </p>
    </div>
    <div class="location-widget__weather">
      ...
      <div class="weather__tempreture">
        <p id="currentTempreture">
          {{ widgetData.forecast.currentTempreture }}°
        </p>
        <p id="highAndLowTempreture">
          H: {{ widgetData.forecast.highAndLowTempreture[0] }}° L:
          {{ widgetData.forecast.highAndLowTempreture[1] }}°
        </p>
      </div>
    </div>
  </section>
